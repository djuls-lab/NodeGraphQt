...
class Vector2InputNode(AutoNode):
    ...
    def __init__(self):
        ...
        self.create_property("out", [0.0, 0.0], widget_type=NODE_PROP_VECTOR2)
...
class Vector3InputNode(AutoNode):
    ...
    def __init__(self):
        ...
        self.output = self.add_output("out", list)
        self.create_property("out", [0.0, 0.0, 0.0], widget_type=NODE_PROP_VECTOR3)
...
class Vector4InputNode(AutoNode):
    ...
    def __init__(self):
        ...
        self.output = self.add_output("out", list)
        self.create_property("out", [0.0, 0.0, 0.0, 0.0], widget_type=NODE_PROP_VECTOR4)
